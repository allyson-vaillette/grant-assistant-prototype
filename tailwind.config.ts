...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      /* ── Type scale ── */
      fontSize: {
        "display": ["22px", { lineHeight: "1.25", fontWeight: "500", letterSpacing: "-0.02em" }],
        "heading":  ["16px", { lineHeight: "1.4",  fontWeight: "500", letterSpacing: "-0.01em" }],
